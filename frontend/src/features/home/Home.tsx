          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-8 mb-8">
            <div className="bg-white/40 md:bg-transparent border border-border/60 md:border-none rounded-xl md:rounded-none p-4 md:p-0 backdrop-blur-sm md:backdrop-blur-0 shadow-sm md:shadow-none">
              ...
              <div className="flex gap-2">
                {SUPPORT_CONFIG.social.instagram.url && (
                  <a href={SUPPORT_CONFIG.social.instagram.url} target="_blank" rel="noopener noreferrer">
                ...
                {SUPPORT_CONFIG.social.twitter.url && (
                  <a href={SUPPORT_CONFIG.social.twitter.url} target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" size="icon" className="rounded-full h-8 w-8">
                ...
                {SUPPORT_CONFIG.social.facebook.url && (
                  <a href={SUPPORT_CONFIG.social.facebook.url} target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" size="icon" className="rounded-full h-8 w-8">

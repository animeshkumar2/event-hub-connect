...
const cateringItems: ListingTemplate[] = [
  {
    ...
    shortDescription: 'Multi-cuisine vegetarian',
    displayPrice: 0,
    priceUnit: 'plate',
  ...
  },
  {
    ...
    categoryId: 'caterer',
    dbCategoryId: 'caterer',
    shortDescription: 'Premium non-veg buffet',
    displayPrice: 0,
    priceUnit: 'plate',
  ...
  },
  {
    ...
    categoryId: 'caterer',
    dbCategoryId: 'caterer',
    shortDescription: '4 live food stations',
    displayPrice: 0,
    priceUnit: 'plate',
...
const venueItems: ListingTemplate[] = [
  {
    ...
    categorySpecificData: {
      ...
      parkingCapacity: 50,
      valetParking: true,
      amenities: ['Air Conditioning', 'Parking', 'Power Backup', 'Restrooms', 'Green Room', 'Stage', 'Dance Floor', 'WiFi', 'Sound System', 'Projector'],
      cateringPolicy: 'Both Options Available',
      decorationPolicy: 'Both Options Available',
  ...
  },
  {
    ...
    categorySpecificData: {
      ...
      venueSession: 'Evening-Dinner (4 PM - 12 AM)',
      price: undefined,
      numberOfHalls: 0,
      capacitySeating: 500,
      ...
      parkingCapacity: 80,
      valetParking: true,
      amenities: ['Parking', 'Power Backup', 'Restrooms', 'WiFi'],
      cateringPolicy: 'Outside Allowed',
      decorationPolicy: 'Outside Decorators Allowed',
      alcoholPolicy: 'Allowed with License',
  ...
  },
  {
    ...
    categorySpecificData: {
      ...
      parkingCapacity: 40,
      valetParking: false,
      amenities: ['Air Conditioning', 'Parking', 'Power Backup', 'Restrooms', 'WiFi', 'Swimming Pool'],
      cateringPolicy: 'Outside Allowed',
      decorationPolicy: 'Outside Decorators Allowed',

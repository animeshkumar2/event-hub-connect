...
import { InteractiveEventShowcase } from '@/components/InteractiveEventShowcase';
import { FuturisticCategoryCarousel } from '@/components/FuturisticCategoryCarousel';
import { PremiumVendorCard } from '@/components/PremiumVendorCard';
import { TrendingSetupCard } from '@/components/TrendingSetupCard';
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/20">
                ...
                {stats.map((stat, index) => {
                  ...
                  return (
                    <div key={index} className="text-center group">
                      <div className="inline-flex p-3 rounded-xl bg-gradient-to-br from-primary/10 to-primary-glow/10 mb-3 group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                    ...
                    <CardContent className="flex flex-col justify-between p-6 md:p-8 bg-gradient-to-br from-slate-50 to-white">
                      <div className="space-y-4">
                        {/* Badge */}
                        <Badge className="bg-primary/10 text-primary border-primary/20 px-3 py-1 text-xs font-medium w-fit">
                        ...
                        <div className="flex items-center gap-6 pt-2">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <div className="text-lg font-bold text-foreground">{trendingSetups[activeSetupIndex].vendorName}</div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <div className="text-lg font-bold text-foreground">{trendingSetups[activeSetupIndex].city}</div>
                      ...
                      {/* CTA Button */}
                      <div className="pt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-t">
                        <div>
                        ...
                        <Button 
                          size="lg" 
                          className="w-full sm:w-auto text-base px-8 py-6 rounded-xl bg-gradient-to-r from-primary to-primary-glow text-white hover:from-primary-glow hover:to-primary font-semibold shadow-lg hover-lift transition-all duration-300 group"
                          asChild
                        >
      ...
      <section className="relative py-20 md:py-32 bg-gradient-to-b from-background via-muted/20 to-background overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mt-12">
            <Button variant="outline" size="lg" asChild className="rounded-xl border-2 hover-lift">
              <Link to="/search">
                View All Vendors
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              return (
                <Card
                  key={index}
                  className="relative overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover-lift rounded-2xl group"
                >
      ...
      {/* Footer - Enhanced */}
      <footer className="border-t border-border py-16 bg-gradient-to-b from-muted/20 to-background">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div>
              <h3 className="font-black text-2xl mb-4 bg-gradient-to-r from-primary to-primary-glow bg-clip-text text-transparent">
                EventHub
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link to="/search" className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
                    <ArrowRight className="h-3 w-3" />
                    Find Vendors
                  </Link>
                </li>
                <li>
                  <Link to="/event-planner" className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
                    <ArrowRight className="h-3 w-3" />
                    Event Planner
                  </Link>
                </li>
                <li>
                  <Link to="/how-it-works" className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
                    <ArrowRight className="h-3 w-3" />
                    How It Works
                  </Link>
                </li>
                <li>
                  <Link to="/pricing" className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
                    <ArrowRight className="h-3 w-3" />
                    Pricing
                  </Link>
                </li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link to="/vendor/signup" className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
                    <ArrowRight className="h-3 w-3" />
                    Become a Vendor
                  </Link>
                </li>
                <li>
                  <Link to="/vendor/login" className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
                    <ArrowRight className="h-3 w-3" />
                    Vendor Login
                  </Link>
                </li>
                <li>
                  <Link to="/vendor/benefits" className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
                    <ArrowRight className="h-3 w-3" />
                    Vendor Benefits
                  </Link>
                </li>
                <li>
                  <Link to="/vendor/pricing" className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
                    <ArrowRight className="h-3 w-3" />
                    Commission Rates
                  </Link>
                </li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li>
                  <Link to="/faq" className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
                    <ArrowRight className="h-3 w-3" />
                    FAQ
                  </Link>
                </li>

...
public class Listing {
    ...
    // Venue-specific location fields (for venue category listings)
    // Requires migration: database/migrations/add_venue_location_to_listings.sql
    ...
    private java.math.BigDecimal venueLatitude;
    
    @Column(name = "venue_longitude", precision = 11, scale = 8)
    private java.math.BigDecimal venueLongitude;
